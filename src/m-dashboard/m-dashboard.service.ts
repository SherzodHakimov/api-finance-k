...
export class MDashboardService {
  ...
  async amountByAccountCurrencyType(): Promise<DataAmountAccountTypeDto[]>{

    return this.prismaService.$queryRaw `
    select r.acc_type,
           r.curr_name,
           sum(r.income - r.outcome) amount
    from (select at.name                                                        acc_type,
                 lc.name                                                        curr_name,
    ...
    group by r.acc_type, r.curr_name;`
  ...
  async amountByAccountTypeConverted(): Promise<DataAmountAccountTypeCurrencyDto[]>{
  ...
  async expensesByCurrencyTypeConverted(reportParams: BetweenDateDto): Promise<DataMainExpenseReportDto> {
